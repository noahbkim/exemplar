if (window.curricula === undefined) window.curricula = {};
window.curricula.cpp = [
  ...
  {
    "id": "constant-variable-associativity",
    "parentIds": [
      "constant-variables",
      "pointers",
      "references"
